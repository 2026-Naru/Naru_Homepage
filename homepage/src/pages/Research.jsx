...
export default function Research() {
  const [researchRef, isVisible] = useInView()
        ...
        <div className="leftsection">
          ...
          <div className="map-title">
            ...
            <div className="area-list">
              {areas.map((area) => (
                <div className="area-item" key={area.title}>
                  <h4 className="area-name">{area.title}</h4>
          ...
          <div className="feature-list">
            {features.map((feature) => (
              <div className="feature-item" key={feature.title}>
                <span className="feature-btn">{feature.title}</span>
        ...
        <div className="resultsection">
          ...
          <div className="result-list">
            {researchResults.map((result) => (
              <div className="result-item" key={result.num}>
                <div className="result-num">0{result.num}</div>
